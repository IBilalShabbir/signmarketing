          ...
          <div className="about__us__container__overlay">
            <Fade left distance="70px">
              <div className="about__us__container__overlay__left">
                <div className="about__us__overlay__left__heading">
                  About Us
                </div>
                <div className="about__us__overlay__left__text">
                  ...
                  Laundry is available on premises.Dream Home is a gated
                  community with a great location. Located downtown, you’re
                  within walking distance of Parks, and the best shopping,
                  dining and entertainment Getting around is a breeze, with easy
                  access to freeways, buses and trolleys. Laundry is available
                  on premises.
                </div>
